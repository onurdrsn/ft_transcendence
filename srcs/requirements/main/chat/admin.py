...
from chat.models import PrivateRoom, RoomChat, UnreadChat
...
admin.site.register(PrivateRoom, PrivateChatRoomAdmin)
...
admin.site.register(RoomChat, RoomChatMessageAdmin)
...
admin.site.register(UnreadChat, UnreadChatRoomMessagesAdmin)
